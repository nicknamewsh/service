...
private AnnouncementDao dao;
	@Override
	public ModelResults getDateList(String noticetitle, long page, long size,String departid)
			 {
		Map<String,Object> param = new HashMap<String, Object>();
		param.put("noticetitle", noticetitle);
		param.put("pageSize", size);
		param.put("pageNum", page);
		if("37".equals(departid)){
			departid ="2";
		}else if("38".equals(departid)){
			departid ="1";
		}else{
			departid ="0";
		}
	...
	public ModelBean addAnnouncement(Announcement announce) {
		...
		param.put("noticename", announce.getNoticename());
	...
	@Override
	public ModelResults getAnnomentListsh(String Noticetitle, long page, long size,String departid)
			 {
		if("37".equals(departid)){
			departid ="2";
		}else if("38".equals(departid)){
	...
	@Override
	public ModelBean getdepa(String id) {
		Map<String,Object> param = new HashMap<String, Object>();
		param.put("id", id);
		ModelBean bean = new ModelBean();
		String a = null;
