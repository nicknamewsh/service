...
public class WarrantyServiceImpl implements WarrantyService{
	...
	@Override
	public ModelBean addWarranty(String repairsname,String repairsphone,String applycontent,String applyaddress,String repairsdate,String applysource,String fj) {
	...
	@Override
	public ModelBean upWarranty(String id,String repairsname,String repairsphone,String applycontent,String applyaddress,String repairsdate,String applysource,String fj) {
		ModelBean bean = new ModelBean();
		Map<String, Object> paramMap = new HashMap<String, Object>();
		if("填报申请".equals(applysource)){
			applysource = "0";
	...
	@Override
	public ModelBean subWarranty(String id,String name,String departid,String tijiaodate) {
		ModelBean bean = new ModelBean();
//		String[] info = id.split(",");
//		Integer[] ids = new Integer[info.length]; 
//		//List list = new ArrayList();
...
//		}
		...
		paramMap.put("tijiaodate", tijiaodate);
