...
public class DepartController {
	...
	@RequestMapping(value = "/getDepartListBy37", method = RequestMethod.POST)
	@ResponseBody
	public ModelBean getDepartListBy37() {
		return  departService.getDepartListBy37();
	}	
	...
	@RequestMapping(value="/getPidsById",method=RequestMethod.POST)
	@ResponseBody
	public  ModelBean getPidsById(@RequestParam(value="departId",required=true)Integer deptId){
		return departService.getPidsById(deptId);
	}
