...
public interface AnnouncementService {
	ModelResults getDateList(String noticeperson,long page,long size,String departid) throws Exception;
	...
	ModelResults getAnnomentListsh(String Noticetitle,long page,long size,String departid) throws Exception;
	
	ModelBean getdepa(String id) throws Exception;
